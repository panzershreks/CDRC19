...
expl <- c("age_standardised_diabetes_prevalence_male","cardiovascular_diseases_ihme_2017",
          ...
          "general_hospitals_per_million_population_oecd","not_for_profit_privately_owned_hospitals_per_million_population_oecd",
          ...
          "case_fatality_rate_of_covid_19_short_term","biweekly_deaths_per_million_people",
          "weekly_cases_per_million_people","weekly_case_growth","doubling_days_of_total_confirmed_deaths_3_day_period",
          "days_since_10_daily_new_confirmed_deaths_recorded","case_fatality_rate_of_covid_19_only_observations_with_100_cases",
          ...
          "total_confirmed_cases_of_covid_19_per_million_people","population_with_access_to_improved_sanitation_x",
          "debt_relief","stringency_index","deaths_from_anthropogenic_pollution_as_a_share_of_total_air_pollution_deaths",
          "yll_rates_from_anthropogenic_air_pollution_per_100_000","income_classification_world_bank_2017",
          "gdp_growth_from_previous_year_2020_q2","gdp","national_poverty_lines_jolliffe_and_prydz_2016",
          "percentage_contribution_of_deprivations_in_education_to_overall_poverty_alkire_and_robles_2016",
          "multidimensional_poverty_headcount_ratio_alkire_and_robles_2016","Infant.mortality.rate")
