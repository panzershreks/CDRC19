...
set.seed(100)
temp_healthcare_d2 <- mice(data = clean_healthcare, m = 5, method = c("cart"), maxit=100)
summary(temp_healthcare_d2)
save(temp_healthcare_d2, file = "temp_healthcare_d2.Rdata")
load(file = "temp_healthcare_d2.Rdata")

completed_healthcare_d2 <- complete(temp_healthcare_d2,1)

full_healthcare_model2 <- lm(total_confirmed_deaths_due_to_covid_19_per_million_people ~ 
     share_of_people_who_disagree_vaccines_are_important_for_children_to_have+
     share_of_people_who_agree_vaccines_are_safe+
     share_of_people_who_disagree_vaccines_are_safe+
     share_of_people_who_agree_vaccines_are_effective+
