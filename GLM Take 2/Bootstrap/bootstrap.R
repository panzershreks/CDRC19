...
missForest_ful_included_vars_bootstrap <- c()
missForest_imp_included_vars_bootstrap <- c()
missForest_mis_included_vars_bootstrap <- c()
...
for (bootstrap_iteration in 1:n_bootstrap_samples) {
  ...
  missForest_included_vars_full <- all.vars(formula(step_full_mod)[-1])
  missForest_ful_included_vars_bootstrap <- c(missForest_ful_included_vars_bootstrap, missForest_included_vars_full)
  ...
  missForest_imp_included_vars_bootstrap <- c(missForest_imp_included_vars_bootstrap, included_vars_imputed)
  missForest_mis_included_vars_bootstrap <- c(missForest_mis_included_vars_bootstrap, included_vars_miss)
...
##----------------------------------------------------------------
missForest_imp_model_var_freq <- data.frame(table(missForest_imp_included_vars_bootstrap))
missForest_miss_model_var_freq <- data.frame(table(missForest_mis_included_vars_bootstrap))
missForest_full_model_var_freq <- data.frame(table(missForest_ful_included_vars_bootstrap))

write.csv(missForest_imp_model_var_freq, file="GLM Take 2/Bootstrap/missForest_cat_imp_var_freq.csv")
write.csv(missForest_miss_model_var_freq, file="GLM Take 2/Bootstrap/missForest_cat_mis_var_freq.csv")
write.csv(missForest_full_model_var_freq, file="GLM Take 2/Bootstrap/missForest_cat_ful_var_freq.csv")

View(missForest_imp_model_var_freq)
View(missForest_miss_model_var_freq)
View(missForest_full_model_var_freq)
